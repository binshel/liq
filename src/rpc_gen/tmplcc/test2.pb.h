...
class A : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:test2.A)
 private:
...
class SearchRequest : public ::google::protobuf::Message {
 public:
  ...
  inline const ::test2::A& a() const;
  inline ::test2::A* mutable_a();
  inline ::test2::A* release_a();
  inline void set_allocated_a(::test2::A* a);
  ...
  // @@protoc_insertion_point(class_scope:test2.SearchRequest)
 private:
...
class SearchResponse : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:test2.SearchResponse)
 private:
...
inline const ::test2::A& SearchRequest::a() const {
  return a_ != NULL ? *a_ : *default_instance_->a_;
}
inline ::test2::A* SearchRequest::mutable_a() {
  set_has_a();
  if (a_ == NULL) a_ = new ::test2::A;
  return a_;
}
inline ::test2::A* SearchRequest::release_a() {
  clear_has_a();
  ::test2::A* temp = a_;
  a_ = NULL;
  return temp;
}
inline void SearchRequest::set_allocated_a(::test2::A* a) {
  delete a_;
  a_ = a;
  if (a) {
    set_has_a();
...
inline const ::test2::A& SearchResponse::a() const {
  return a_ != NULL ? *a_ : *default_instance_->a_;
}
inline ::test2::A* SearchResponse::mutable_a() {
  set_has_a();
  if (a_ == NULL) a_ = new ::test2::A;
  return a_;
}
inline ::test2::A* SearchResponse::release_a() {
  clear_has_a();
  ::test2::A* temp = a_;
  a_ = NULL;
  return temp;
}
inline void SearchResponse::set_allocated_a(::test2::A* a) {
  delete a_;
  a_ = a;
  if (a) {
    set_has_a();
